...
parser.add_argument('-p', '--path', type=str, default='/data/dailinrui/SSL4MIS/model/refuge2020/Fully_Supervised_400')
...
if __name__ == '__main__':
    ...
    d2 = d['exp']
    d3 = d['path']
    P = namedtuple('P', ['dataset', 'exp', 'path'])
    ...
    net = CU3D(in_channels=param.dataset.n_mode).cuda(args.gpu)
